...
#include <Color.h>
#include <engine/protobuf/netmessages.pb.h>
#include <vector2d.h>
#include <vector.h>
...
namespace SourceModNetMessages
{
	...
	public:
		...
		inline protobuf::Message* MakeCopy(SMProtobufMessage *value)
		{
			auto* oldMsg = this->GetProtobufMessage();
			auto* newMsg = protobuf::MessageFactory::generated_factory()
				->GetPrototype(oldMsg->GetDescriptor())->New();

			newMsg->CopyFrom(*oldMsg);
			return newMsg;
		}
